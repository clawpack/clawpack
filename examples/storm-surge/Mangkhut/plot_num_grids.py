...
if __name__ == "__main__":
    ...
    landfall = datetime.datetime(2018, 9, 16, 6) - datetime.datetime(2018, 9, 16, 6)
    ...
    axes.set_yscale('log')
    time = [-3, -2.75, -2.5, -2.25, -2.0, -1.75, -1.5, -1.25, -1.0, -0.75, -0.5, -0.25, 0, 0.25, 0.5, 0.75]
    print("time = ", time)
    print("num_grids.transpose()", num_grids.transpose())

...
#------------------------------
    ...
    clawdata.xlower = -0.95
    clawdata.xupper = 1.05
...
#-------------------
    ...
    geodata.topofiles.append([2, 1, 1, 0., 1.e10, 'domain.topotype2'])
    ...
    geodata.dtopofiles.append([1,1,1,'fault1.tt1'])
    ...
    geodata.regions.append([1, 1, 0., 1.e9, -2,2,-2,2])  # whole domain
    geodata.regions.append([2, 2, 0., 1.e9, 0., 1.05, 0., 1.50]) # fault to shore
    geodata.regions.append([3, 3, 1800., 1.e9, 0.95, 1.05,0.95,1.05]) # shore

    # == setgauges.data values ==
    geodata.gauges = []
    # for gauges append lines of the form  [gaugeno, x, y, t1, t2]
    geodata.gauges.append([1, 1.008, 1.0, 0., 1.e10])
    geodata.gauges.append([2, 1.010, 1.0, 3600., 1.e10])  # start at 1 hour
    geodata.gauges.append([3, 1.012, 1.0, 3600., 1.e10])
    ...
    geodata.fixedgrids.append([2500.,9000.,13,0.99,1.02,0.985,1.015,101,101,0,1])

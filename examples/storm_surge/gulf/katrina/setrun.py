...
#------------------------------
    ...
    if clawdata.outstyle==1:
        ...
        # Katrina 2005083012
        clawdata.tfinal = days2seconds(241.0)
...
#-------------------
    ...
    geodata.gauges.append([1, -89.5, 29.6,  rundata.clawdata.t0, rundata.clawdata.tfinal])
...
def set_storm():
   ...
   # Physics parameters
    ...
    data.storm_file = os.path.expandvars('$DATA_PATH/katrina.data')

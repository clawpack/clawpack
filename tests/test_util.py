...
class TestFetchNoaaTideData:
    ...
    water_level_url = '{}?product={}&station={}'.format(NOAA_API_URL,
            'water_level', station)
    predictions_url = '{}?product={}&station={}'.format(NOAA_API_URL,
            'predictions', station)
    ...
    def test_retrieve_and_cache(self, mock):
        ...
        date_time_range = ['2000-10-30T12:00', '2000-10-30T12:06',
                '2000-10-30T12:12', '2000-10-30T12:18', '2000-10-30T12:24']

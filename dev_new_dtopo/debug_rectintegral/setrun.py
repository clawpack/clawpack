...
#------------------------------
    ...
    #clawdata.lower[0] = 0.5
    #clawdata.upper[0] = 1.0
    #clawdata.lower[1] = 0.75
    #clawdata.upper[1] = 1.25

    #clawdata.lower[0] = 0.68
    #clawdata.upper[0] = 0.715
    #clawdata.lower[1] = 1.1
    #clawdata.upper[1] = 1.145


    # Number of grid cells: Coarsest grid
    clawdata.num_cells[0] = 202
    clawdata.num_cells[1] = 202
...
#-------------------
    ...
    topo_data.topofiles.append([2, 1, 10, 0., 1.e10, 'bowl2.topotype2'])
    topo_data.topofiles.append([2, 1, 10, 0., 1.e10, 'bowl3.topotype2'])
    topo_data.topofiles.append([2, 1, 10, 0., 1.e10, 'bowl4.topotype2'])
    topo_data.topofiles.append([2, 1, 10, 0., 1.e10, 'bowl5.topotype2'])
    topo_data.topofiles.append([2, 1, 10, 0., 1.e10, 'bowl6.topotype2'])

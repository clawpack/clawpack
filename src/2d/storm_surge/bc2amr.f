      ...
      do 115 j = 1,ncol
         do 115 i=1,nxl
            do 115 m=1,meqn
               ...
               aux(wind_index,i,j) = aux(wind_index,nxl+1,j)
               aux(wind_index+1,i,j) = aux(wind_index+1,nxl+1,j)
               aux(pressure_index,i,j) = aux(pressure_index,nxl+1,j)
      ...
      do 215 i=ibeg,nrow
         do 215 m=1,meqn
            do 215 j = 1,ncol
               ...
               aux(wind_index,i,j) = aux(wind_index,ibeg-1,j)
               aux(wind_index+1,i,j) = aux(wind_index+1,ibeg-1,j)
               aux(pressure_index,i,j) = aux(pressure_index,ibeg-1,j)
      ...
      do 315 j=1,nyb
         do 315 i=1,nrow
            do 315 m=1,meqn
                ...
                aux(wind_index,i,j) = aux(wind_index,i,nyb+1)
                aux(wind_index+1,i,j) = aux(wind_index+1,i,nyb+1)
                aux(pressure_index,i,j) = aux(pressure_index,i,nyb+1)
      ...
      do 415 j=jbeg,ncol
         do 415 i=1,nrow
            do 415 m=1,meqn
               ...
               aux(wind_index,i,j) = aux(wind_index,i,jbeg-1)
               aux(wind_index+1,i,j) = aux(wind_index+1,i,jbeg-1)
               aux(pressure_index,i,j) = aux(pressure_index,i,jbeg-1)
